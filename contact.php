 ...
 <body>
     <nav>
         <div class="navbar">
             ...
             <li><a href="">FAQ</a></li>
             <li id="active"><a href="website/contact.php/">Contact</a></li>
             <li><a href="/website/login.php" class="button acc-btn"><i class="fa-regular fa-user icon"></i></a></li>
         </div>
     </nav>
